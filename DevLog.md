...
### October 8th:
The very first meeting of the industrial project group. We get introduced with the NXP project, make acquaintance with out tutor and know the colleages from the same lab room.
...
4. Accomplish installing and running the Gazebo simulation and QGroundControl. 
